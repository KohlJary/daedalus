"""
Labyrinth - MUD-based codebase navigation for LLM agents.

Part of the Daedalus plugin ecosystem. A spatial-semantic architecture that
represents codebases as navigable MUD environments, enabling LLM agents to
maintain architectural coherence through narrative/spatial metaphor.

Usage:

    from daedalus.labyrinth import PalaceStorage, Navigator, Cartographer
